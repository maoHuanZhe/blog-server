...
import com.fgrapp.blog.blogserver.common.exception.LimitAccessException;
import com.fgrapp.blog.blogserver.common.util.HttpContextUtil;
import com.fgrapp.blog.blogserver.common.util.IPUtil;
...
public class LimitAspect extends AspectSupport {
    ...
    @Pointcut("@annotation(com.fgrapp.blog.blogserver.common.annotation.Limit)")

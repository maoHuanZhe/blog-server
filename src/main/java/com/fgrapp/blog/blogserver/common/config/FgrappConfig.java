...
import com.fgrapp.blog.blogserver.common.properties.SwaggerProperties;
import com.fgrapp.blog.blogserver.common.util.Constant;
import com.fgrapp.blog.blogserver.common.xss.XssFilter;
...
@Configuration
@EnableSwagger2
public class FgrappConfig {
    @Autowired
    private FgrProperties properties;

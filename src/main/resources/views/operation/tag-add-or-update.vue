<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      ...
      <el-form-item label="所属类别：0文章，1类别" prop="type">
        <el-input v-model="dataForm.type" placeholder="所属类别：0文章，1类别"></el-input>
      </el-form-item>
    </el-form>
  ...
  data () {
    return {
      ...
      dataRule: {
        ...
        name: [{ required: true, message: '标签名字不能为空', trigger: 'blur' }],
        type: [{ required: true, message: '所属类别：0文章，1类别不能为空', trigger: 'blur' }]
      }
    }
  },
  methods: {
